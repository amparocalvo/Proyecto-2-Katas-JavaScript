...
const total= exams.reduce((suma,exam)=> suma +exam.score,0);
console.log(total);

/*6.2 Dado el mismo array, haz una suma de todos las notas de los examenes de los
alumnos que esten aprobados usando la función .reduce().*/

const sumaAprobados = exams.reduce((suma,exam) =>suma + (exam.score >=5  ? exam.score:0),0 );
...
const sumaTotal= exams.reduce((suma,exam)=> suma +exam.score,0);
