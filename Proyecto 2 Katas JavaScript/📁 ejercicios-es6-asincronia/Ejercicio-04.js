...
const big18= ages.filter(age=>age>18);
console.log(big18);
...
const streamers1 = streamers.filter(streamer => streamer.gameMorePlayed == 'League of Legends');
...
.includes() para la comprobación. Además, pon el valor de la propiedad .gameMorePlayed a MAYUSCULAS cuando .age sea mayor que 35.*/
